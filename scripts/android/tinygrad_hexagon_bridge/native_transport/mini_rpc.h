...
/**
    ...
    * @retval, 0 on success
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(mini_rpc_open)(const char* uri, remote_handle64* h) __QAIC_HEADER_ATTRIBUTE;
/** 
    ...
    */
__QAIC_HEADER_EXPORT int __QAIC_HEADER(mini_rpc_close)(remote_handle64 h) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(mini_rpc_run_add)(remote_handle64 _h, int32 a, int32 b, int32* result) __QAIC_HEADER_ATTRIBUTE;
__QAIC_HEADER_EXPORT AEEResult __QAIC_HEADER(mini_rpc_run_kernel)(remote_handle64 _h, const unsigned char* a, int aLen, const unsigned char* b, int bLen, unsigned char* c, int cLen) __QAIC_HEADER_ATTRIBUTE;
#ifndef mini_rpc_URI
#define mini_rpc_URI "file:///libmini_rpc_skel.so?mini_rpc_skel_handle_invoke&_modver=1.0"
#endif /*mini_rpc_URI*/
#ifdef __cplusplus
}
#endif
