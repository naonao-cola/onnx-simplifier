#ifndef _MINI_RPC_STUB_H
#define _MINI_RPC_STUB_H
#include "mini_rpc.h"
#include <string.h>
#ifndef _WIN32
#include "HAP_farf.h"
...
extern "C" {
#endif
__QAIC_STUB_EXPORT int __QAIC_STUB(mini_rpc_open)(const char* uri, remote_handle64* h) __QAIC_STUB_ATTRIBUTE {
   return __QAIC_REMOTE(remote_handle64_open)(uri, h);
}
__QAIC_STUB_EXPORT int __QAIC_STUB(mini_rpc_close)(remote_handle64 h) __QAIC_STUB_ATTRIBUTE {
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(mini_rpc_run_add)(remote_handle64 _handle, int32 a, int32 b, int32* result) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 2;
   return _stub_method(_handle, _mid, (uint32_t*)&a, (uint32_t*)&b, (uint32_t*)result);
}
static __inline int _stub_method_1(remote_handle64 _handle, uint32_t _mid, char* _in0[1], uint32_t _in0Len[1], char* _in1[1], uint32_t _in1Len[1], char* _rout2[1], uint32_t _rout2Len[1]) {
   int _numIn[1] = {0};
   remote_arg _pra[4] = {0};
...
__QAIC_STUB_EXPORT AEEResult __QAIC_STUB(mini_rpc_run_kernel)(remote_handle64 _handle, const unsigned char* a, int aLen, const unsigned char* b, int bLen, unsigned char* c, int cLen) __QAIC_STUB_ATTRIBUTE {
   uint32_t _mid = 3;
   return _stub_method_1(_handle, _mid, (char**)&a, (uint32_t*)&aLen, (char**)&b, (uint32_t*)&bLen, (char**)&c, (uint32_t*)&cLen);
}
#ifdef __cplusplus
}
#endif
#endif //_MINI_RPC_STUB_H
