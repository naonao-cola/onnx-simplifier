#ifndef _MINI_RPC_SKEL_H
#define _MINI_RPC_SKEL_H
#include "mini_rpc.h"
...
#ifndef _MINI_RPC_SLIM_H
#define _MINI_RPC_SLIM_H
#include <stdint.h>
...
static const Parameter* const parameterArrays[9] = {(&(parameters[5])),(&(parameters[5])),(&(parameters[6])),(&(parameters[3])),(&(parameters[3])),(&(parameters[4])),(&(parameters[0])),(&(parameters[1])),(&(parameters[2]))};
static const Method methods[4] = {{REMOTE_SCALARS_MAKEX(0,0,0x2,0x0,0x0,0x1),0x4,0x0,2,2,(&(parameterArrays[6])),0x4,0x1},{REMOTE_SCALARS_MAKEX(0,0,0x0,0x0,0x1,0x0),0x0,0x0,1,1,(&(parameterArrays[8])),0x1,0x0},{REMOTE_SCALARS_MAKEX(0,0,0x1,0x1,0x0,0x0),0x8,0x4,3,3,(&(parameterArrays[3])),0x4,0x4},{REMOTE_SCALARS_MAKEX(0,0,0x3,0x1,0x0,0x0),0xc,0x0,7,3,(&(parameterArrays[0])),0x4,0x1}};
static const Method* const methodArrays[4] = {&(methods[0]),&(methods[1]),&(methods[2]),&(methods[3])};
static const char strings[50] = "run_kernel\0run_add\0result\0close\0open\0uri\0c\0b\0a\0h\0";
static const uint16_t methodStrings[13] = {0,45,43,41,11,45,43,19,32,37,47,26,47};
static const uint16_t methodStringsArrays[4] = {8,11,4,0};
__QAIC_SLIM_EXPORT const Interface __QAIC_SLIM(mini_rpc_slim) = {4,&(methodArrays[0]),0,0,&(methodStringsArrays [0]),methodStrings,strings};
#endif //_MINI_RPC_SLIM_H
extern int adsp_mmap_fd_getinfo(int, uint32_t *);
#ifdef __cplusplus
extern "C" {
#endif
_ATTRIBUTE_VISIBILITY uint32_t mini_rpc_skel_handle_invoke_qaic_version = 10049;
_ATTRIBUTE_VISIBILITY char mini_rpc_skel_handle_invoke_uri[67+1]="file:///libmini_rpc_skel.so?mini_rpc_skel_handle_invoke&_modver=1.0";
static __inline int _skel_method(int (*_pfn)(remote_handle64, const unsigned char*, int, const unsigned char*, int, unsigned char*, int), remote_handle64 _h, uint32_t _sc, remote_arg* _pra) {
   ...
   _QAIC_ASSERT(_nErr, (_pra + ((3 + 1) + (((0 + 0) + 0) + 0))) <= _praEnd);
   ...
   _TRY(_nErr, _pfn(_h, (const unsigned char*)*_in0, (int)*_in0Len, (const unsigned char*)*_in1, (int)*_in1Len, (unsigned char*)*_rout2, (int)*_rout2Len));
   _QAIC_CATCH(_nErr) {}
   return _nErr;
}
...
__QAIC_SKEL_EXPORT int __QAIC_SKEL(mini_rpc_skel_handle_invoke)(remote_handle64 _h, uint32_t _sc, remote_arg* _pra) __QAIC_SKEL_ATTRIBUTE {
   switch(REMOTE_SCALARS_METHOD(_sc)){
      case 0:
      return _skel_method_3(__QAIC_IMPL(mini_rpc_open), _sc, _pra);
      case 1:
      return _skel_method_2(__QAIC_IMPL(mini_rpc_close), _sc, _pra);
      case 2:
      return _skel_method_1(__QAIC_IMPL(mini_rpc_run_add), _h, _sc, _pra);
      case 3:
      return _skel_method(__QAIC_IMPL(mini_rpc_run_kernel), _h, _sc, _pra);
   }
