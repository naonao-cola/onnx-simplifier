/* One MCC decoder block (../vision_models/mcc/model.py QueryDecoder, per block) for a chunk of Q queries,
 * fused on Hexagon V69: the GEMMs on HMX (../hmx_gemm/hmx_block.h), everything else on HVX (mb_hvx.h; a
