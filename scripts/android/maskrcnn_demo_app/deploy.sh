...
# Then:  adb shell am start -n org.onnxsim.maskrcnndemo/.MainActivity [--es mode images] [--es pipe pipe_e_opt_ctx.txt]
#
...
FILES="pipe_e_opt.txt pipe_e_opt_ctx.txt levels.txt model.txt l0_anchors.bin l1_anchors.bin l2_anchors.bin l3_anchors.bin
...
# absent, the app compiles them itself on the first pipe_e_opt_ctx.txt launch.
