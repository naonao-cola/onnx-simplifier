...
| Camera demo (`firmware/camera_demo/`, M5StickV only) | **Run on a real M5StickV**: live camera -> KPU (Sobel edge model, 13 fps) -> LCD, colours and edge map checked by eye. Numeric comparison with onnxruntime not done; browser flasher not tried with this board -- see `firmware/camera_demo/README.md` |
